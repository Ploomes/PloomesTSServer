...
export const createConnection = (baseUrl: string): IConnection => {
  const connection: IConnection = {
    ...
    get: (url: string): Promise<any> => {
      return new Promise((res, rej) => {
        connection.request(url, "GET", {}).then((data) => {
          res(data);
        });
      });
    },
    ...
    post: (url: string, body: any) => {
      return new Promise((res, rej) => {
        connection.request(url, "POST", body).then((data) => {
          console.log(data);
          res(data);
        });
      });
    ...
    patch: (url: string, body: any) => {
      return new Promise((res, rej) => {
        connection.request(url, "PATCH", body).then((data) => {
          console.log(data);
          res(data);
        });
      });
    ...
    delete: (url: string) => {
      return new Promise((res, rej) => {
        connection.request(url, "DELETE", {}).then((data) => {
          console.log(data);
          res(data);
        });
      });
