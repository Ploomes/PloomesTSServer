...
var PloomesServer = /** @class */ (function () {
    ...
    PloomesServer.prototype.login = function () {
        ...
        return new Promise(function (res, rej) {
            axios_1.default
                ...
                .catch(function (e) { return rej(e.response); });
        });
    };
    /**
     * get
     ...
     * returns Promise<any[]>
     */
    PloomesServer.prototype.get = function (url, headers) {
        var _this = this;
        if (headers === void 0) { headers = {}; }
        return new Promise(function (res, rej) {
            _this.request(url, 'GET', undefined, headers).then(res).catch(rej);
        });
    };
    /**
     * delete
     ...
     * returns Promise<any[]>
     */
    PloomesServer.prototype.delete = function (url, body, headers) {
        var _this = this;
        if (headers === void 0) { headers = {}; }
        return new Promise(function (res, rej) {
            _this.request(url, 'DELETE', body || undefined, headers)
                .then(res)
                .catch(rej);
        });
    };
     ...
     * returns Promise<any[]>
     */
    PloomesServer.prototype.post = function (url, body, headers) {
        var _this = this;
        if (headers === void 0) { headers = {}; }
        return new Promise(function (res, rej) {
            _this.request(url, 'POST', body, headers).then(res).catch(rej);
        });
    };
    /**
     * patch
     ...
     * returns Promise<any[]>
     */
    PloomesServer.prototype.patch = function (url, body, headers) {
        var _this = this;
        if (headers === void 0) { headers = {}; }
        return new Promise(function (res, rej) {
            _this.request(url, 'PATCH', body, headers).then(res).catch(rej);
        });
    };
    PloomesServer.prototype.request = function (url, method, body, headers) {
        var _this = this;
        if (headers === void 0) { headers = {}; }
        return new Promise(function (res, rej) {
            axios_1.default
                ...
                method: method,
                data: body || {},
                headers: __assign({ 'Content-Type': 'application/json', 'User-Key': _this.userKey }, headers),
            })
                .then(function (_a) {
                var data = _a.data;
                if (data) {
